                ...
                <div class="card border-0 shadow-sm mb-3">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#addEmployeeModal">
                            ...
                            <table class="table table-hover table-bordered table-striped table-sm">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $result->fetch_assoc()) { ?>
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-center justify-content-start p-2">
                                                <div class="editbtn mx-2">
                                                    <button type="button" class="btn btn-link text-decoration-none" data-bs-toggle="modal" data-bs-target="#editEmployeeModal<?php echo $row['id']; ?>">
                                                        <i class="bi bi-pencil-square mx-1"></i>Edit
                                                    </button>
                                                </div>
                                                <div class="delbtn">
                                                    <button type="button" class="btn btn-link text-decoration-none bg-danger" data-bs-toggle="modal" data-bs-target="#deleteEmployeeModal<?php echo $row['id']; ?>">
                                        ...
                                        <!-- Edit Employee -->
                                        <div class="modal fade" id="editEmployeeModal<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="editEmployeeModalLabel<?php echo $row['id']; ?>" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title mx-2" id="editEmployeeModalLabel<?php echo $row['id']; ?>">
                                        ...
                                        <!-- Confirming deletion -->
                                        <div class="modal fade" id="deleteEmployeeModal<?php echo $row['id']; ?>" tabindex="-1" aria-labelledby="deleteEmployeeModalLabel<?php echo $row['id']; ?>" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="deleteEmployeeModalLabel<?php echo $row['id']; ?>">
                                                            <i class="bi bi-trash-fill mx-1"></i>Confirm Deletion
                                                        </h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body mt-3">
                                                        <p>Are you sure you want to delete employee <strong><?php echo $row['username']; ?></strong>?</p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        ...
                                                        <form action="delete_employee.php?id=<?php echo $row['id']; ?>" method="POST">
                                        ...
                                        <div class="modal fade" id="addEmployeeModal" tabindex="-1" aria-labelledby="addEmployeeModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title mx-2" id="addEmployeeModalLabel">
                                                            <i class="bi bi-person-plus-fill"></i> Add New Employee
                                                        </h5>
                                                        <button type="button" class="btn-close mx-2" data-bs-dismiss="modal" aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        <form action="add_employee.php?id=<?php echo $row['id']; ?>" method="POST">
                                                            <div class="px-5">
                                                                <div class="col-md-12 p-0 mb-2">
                                                                    <label for="username" class="form-label">Username:</label>
                                                                    <div>
                                                                ...
                                                                <div class="form-group row mt-4">
                                                                    <div class="col-md-12 text-end">
                                                                        <button type="submit" class="btn btn-primary mb-2" name="update">Add Employee Account</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </form>
